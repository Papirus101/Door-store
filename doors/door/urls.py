...
from .views import ConstrucorDoor, DoorDetail, EditOrderManager, Index, OrderDetail, OrdersList, ProfileView, register, login_user, logout_user
...
urlpatterns = [
    ...
    path('orders/<str:username>/', OrdersList.as_view(), name='orders'),
